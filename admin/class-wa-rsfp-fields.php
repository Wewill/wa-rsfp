	...
	$meta_boxes[] = [
		...
		'fields'     => [
			[
				...
				'desc' => __( 'Ex. : chiffre d\'affaire actuel et évolution, charges, EBE, salaires, valeurs ajoutées ...' . '<br/>' . '<span class="label">TIPS</span> Markdown is available : *italic* (Command + b) **bold** (Command + i) ***label*** (Command + Shift + L) #small# (Command + Shift + S) ##huge## (Command + Shift + H).', 'wa-rsfp' ),
            ],
            [
                ...
                'class' => 'enable-markdown',
				'label_description' => __( '<span class="label">INFO</span> Fill with simple text', 'wa-rsfp' ) . '<br/>' .   __( '<span class="label">INFO</span> This will be rendered as a list of items', 'wa-rsfp' ),
				'desc' => __( 'Ex. : répartition des tâches, horaires quotidiens, congés ...' . '<br/>' . '<span class="label">TIPS</span> Markdown is available : *italic* (Command + b) **bold** (Command + i) ***label*** (Command + Shift + L) #small# (Command + Shift + S) ##huge## (Command + Shift + H).', 'wa-rsfp' ),
            ],
            // [
